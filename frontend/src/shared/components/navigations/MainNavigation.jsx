...
function MainNavigation(props) {
  ...
  return (
    ...
    {isContextMenuExpanded && <ContextMenu onSelect={eh_contextMenuButton}>
      ...
      <MainHeader>
        <button className={`main-navigation__menu-btn ${isContextMenuExpanded && "open"}`} onClick={eh_contextMenuButton}>
