      ...
      <ul className="social_icons">
        <li>
          <a
            ...
            href="https://www.instagram.com/aaugustgames/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            className="social_icon"
            href="https://www.linkedin.com/in/khaled-rakhisi-950962a8/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            className="social_icon"
            href="https://github.com/khaledrakhisi"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            className="social_icon"
            href="https://www.youtube.com/channel/UCzEZWRWmqbIRDbNxghOM8ew"
            target="_blank"
            rel="noreferrer"
          >
