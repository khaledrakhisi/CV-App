...
const Span = styled.span.attrs((props) => ({
  ...
  & {
    ...
    --left: ${(props) =>
      props.left !== "unset" ? props.left + "px" : "unset"};
    --right: ${(props) =>
      props.right !== "unset" ? props.right + "px" : "unset"};
    --bg-color: ${(props) => props.bgColor};
    --text-color: ${(props) => props.textColor};
    --height: ${(props) => props.height}px;
    --width: ${(props) => props.width}px;
    --render-delay: ${(props) => props.renderDelay}s;
    --shake-delay: ${(props) => props.renderDelay + 0.6}s;
  ...
  animation: ${fadeIn} 400ms ease-in-out var(--render-delay) forwards,
    ${shake} 300ms ease-in-out var(--shake-delay) forwards;
